        ...
        <div class="col-sm-12 col-md-8 col-md-offset-2">
                <div class="panel b-primary bt-md">
                    <div class="panel-content">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <form class="form-horizontal" method="POST" action="{{ route('add-counterCategoryPost',$counterCategory->id)}}" >
                                    @csrf
                                    @method('PATCH')

                                    <div class="form-group text-md">
                                        <label for="title" class="col-sm-4 control-label"> Counter Title<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <input readonly class="form-control" id="title" name="title" value="{{$counterCategory['title']}}">
                                    ...
                                    <div class="form-group text-md">
                                        <label for="counter" class="col-sm-4 control-label">Add Counter<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="counter" name="counter" placeholder="Enter the newly added number">
