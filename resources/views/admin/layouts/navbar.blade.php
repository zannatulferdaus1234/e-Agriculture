<nav>
    ...
    <!--Category-->
        <li class="has-child-item close-item {{ request()->is('category*') ? 'open-item':''}}">
            ...
            <ul class="nav child-nav level-1">
                <li class="{{ request()->is('category/add','category/edit/*') ? 'active-item':''}}"><a href="{{ route('create-category')}}">Add category</a></li>
    ...
    <!--Sub Category-->
        <li class="has-child-item close-item {{ request()->is('subCategory*') ? 'open-item':''}}">
            ...
            <ul class="nav child-nav level-1">
                <li class="{{ request()->is('subCategory/add','subCategory/edit/*') ? 'active-item':''}}"><a href="{{ route('create-sub_category')}}">Add SubCategory</a></li>
    ...
    <li class="has-child-item close-item {{ request()->is('contents*') ? 'open-item':''}}">
        ...
        <ul class="nav child-nav level-1">
            <li class="{{ request()->is('contents/add','subCategory/edit/*') ? 'active-item':''}}"><a href="{{ route('create-content')}}">Add Content</a></li>
            <li class="{{ request()->is('contents','contents/*/edit') ? 'active-item':''}}"><a href="{{ route('manage-content')}}">Manage Content</a></li>
        </ul>
    </li>
        ...
        <li class="has-child-item close-item {{ request()->is('comments*') ? 'open-item':''}}">
            ...
            <ul class="nav child-nav level-1">
                <li class="{{ request()->is('contents','contents/*/edit') ? 'active-item':''}}"><a href="{{ route('manage-content')}}">Add Comment</a></li>

                <li class="{{ request()->is('comments','comment/show','content/*/comment/*/edit') ? 'active-item':''}}"><a href="{{ route('manage-comments')}}">Manage Comment</a></li>
            </ul>
        </li>
        ...
        <li class="has-child-item close-item {{ request()->is('replies*') ? 'open-item':''}}">
            ...
            <ul class="nav child-nav level-1">
                <li class="{{ request()->is('comment/3/reply/add') ? 'active-item':''}}"><a href="{{ route('manage-comments')}}">Add Reply</a></li>

                <li class="{{ request()->is('replies') ? 'active-item':''}}"><a href="{{ route('manage-reply')}}">Manage Reply</a></li>
            </ul>
        </li>
        ...
        <li class="has-child-item close-item {{ request()->is('solutions*') ? 'open-item':''}}">
            ...
            <ul class="nav child-nav level-1">
                <li class="{{ request()->is('questions/add','questions/*/edit') ? 'active-item':''}}"><a href="{{ route('manage-crops_question')}}">Add Solution</a></li>
                <li class="{{ request()->is('solutions*') ? 'active-item':''}}"><a href="{{ route('manage-crops_solution')}}">All Solutions</a></li>
            </ul>
        </li>
