                ...
                <div class="panel b-primary bt-md">
                    <div class="panel-content">
                        ...
                        <div class="row text-md">
                            <div class="col-md-10">
                                <form class="form-horizontal" method="POST" action="{{ route('store-crops_question')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="soil_type" name="soil_type" value="{{old('soil_type')}}" placeholder="Enter soil type">
