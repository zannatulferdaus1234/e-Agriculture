    ...
    <section class="wf100 p100 inner-header">
        <div class="container">
            ...
            <ul>
                ...
                <li><a href="javascript:avoid(0)"> About Us </a></li>
            </ul>
        </div>
    </section>
    <!--Inner Header End-->
    ...
    <section class="wf100 about">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-text">
                            ...
                            <a href="{{ route('ask-question') }}">Contact Us</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-video-img"> <a href="#"><i class="fas fa-play"></i></a> <img
                                src="{{ asset('/') }}assets/webapp/images/aboutimg.jpg" alt=""> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="our-success-story wf100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="story-title-bg"> <strong class="t1">ecova.</strong> <strong class="t2">20+</strong>
                            <strong class="t3">Years of
                                Services</strong>
                        </div>
                    </div>
                    <div class="col-lg-8">
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="testimonials" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                ...
                                <div class="tuser"> <img src="images/tuser2.jpg" alt=""> <strong>Richardson</strong> Florida
                                    Partner </div>
                            </div>
                            <!--testimonials box End-->
                            <!--testimonials box start-->
