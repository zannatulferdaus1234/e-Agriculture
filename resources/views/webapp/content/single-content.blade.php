             ...
             <div class="col-lg-9 col-md-8">
                ...
                <div class="blog-single-content">
                   ...
                   <ul class="small-gallery">
                      <li> <img src="{{ asset('/') }}assets/webapp/images/blog/bsmall1.jpg" alt=""> </li>
                      <li> <img src="{{ asset('/') }}assets/webapp/images/blog/bsmall2.jpg" alt=""> </li>
                      <li> <img src="{{ asset('/') }}assets/webapp/images/blog/bsmall3.jpg" alt=""> </li>
                   </ul>
                   <!--Post Tags Start-->
                   ...
                   <div class="post-comments wf100">
                       <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class=" btn btn-primary text-light" href="{{ route('add-comment',[$content->sub_category->name,$content->id])}}">Leave Your Comment</a>
                        </div>
                   ...
                   <div class="wf100 comment-form">
                       @auth('end_user')
                            ...
                            <ul>
                                <li class="full">
                                <a class=" btn post-btn text-light" href="{{ route('add-comment',[$content->sub_category->name,$content->id])}}">Post Your Comment</a>
                                </li>
                             </ul>
                        @else
                ...
                <div class="sidebar">
                   ...
                   <div class="side-widget">
                      ...
                      <ul class="lastest-products">
                         <li> <img src="{{ asset('/') }}assets/webapp/images/flp1.jpg" alt=""> <strong><a href="#">How you can keep alive wild animals for...</a></strong> <span class="pdate"><i class="fas fa-calendar-alt"></i> 29 September, 2018</span> </li>
                         <li> <img src="{{ asset('/') }}assets/webapp/images/flp2.jpg" alt=""> <strong><a href="#">Eliminate your plastic bottle pollution</a></strong> <span class="pdate"><i class="fas fa-calendar-alt"></i> 29 September, 2018</span> </li>
                         <li> <img src="{{ asset('/') }}assets/webapp/images/flp3.jpg" alt=""> <strong><a href="#">How you can keep alive wild animals for...</a></strong> <span class="pdate"><i class="fas fa-calendar-alt"></i> 29 September, 2018</span> </li>
                      </ul>
                   </div>
                   <!--Widget Start-->
                   <!--Widget Start-->
